Ext.define('peq.view.home.HomeController', {
    ...
    onAfterRenderContent: function(e) {
        ...
        html += '<div style="margin: 5px; margin-left: 10px; margin-right: 10px; margin-top: 10px; border-radius: 12px; background-color: #151515; color: #BDBDBD; border: 1px solid #000; opacity: 0.6;"><div style="padding-left: 15px; padding-right: 15px;"><h1 style="text-align: center;">PEQ Editor Commit Activity - <a href="https://github.com/project-everquest/peq" style="color: white; text-decoration: none; font-size: 17px;"><i class="fa fa-github-alt"></i> Github Repository</a></h1><p id="git_commit_peq"></p></div></div>';
        html += '<div style="margin: 5px; margin-left: 10px; margin-right: 10px; margin-top: 10px; border-radius: 12px; background-color: #151515; color: #BDBDBD; border: 1px solid #000; opacity: 0.6;"><div style="padding-left: 15px; padding-right: 15px;"><h1 style="text-align: center;">PEQ API Commit Activity - <a href="https://github.com/project-everquest/api" style="color: white; text-decoration: none; font-size: 17px;"><i class="fa fa-github-alt"></i> Github Repository</a></h1><p id="git_commit_api"></p></div></div>';
